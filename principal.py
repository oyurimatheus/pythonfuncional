...
'''
    ...
    opcoes = {
        1: _mostra_total_gastos,
        2: _mostra_gastos_frequentes,
        3: _mostra_total_de_gasto_da_categoria,
        4: _mostra_lista_de_gastos_da_categoria,
        5: _mostra_5_maiores_gastos,
        6: _mostra_5_menores_gastos
...
def _mostra_lista_de_gastos_da_categoria(gastos):
...
def _mostra_total_de_gasto_da_categoria(gastos):
    categoria = input('Digite o nome da categoria: ')
...
def _mostra_gastos_frequentes(gastos):
